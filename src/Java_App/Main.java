...
public class Main {
    ...
    private static final String customer_folder = "C:\\Users\\91628\\Banking Management System\\";
    ...
    public static void displayHomeScreen(){
        System.out.println();
        System.out.println("*** WELCOME TO Thakur Bank! ***");
        ...
        if (choice == 1){
            ...
            System.out.println("Thanks for using Thakur Bank... Have a nice day!");
            System.exit(0);
        }
        else{
    ...
    public static void displayLoginScreen() {
        ...
        switch (choice) {
            ...
            case 3:
                System.out.println("Thanks for using Thakur Bank!");
                System.exit(0);
            default:
                System.out.println("Invalid choice.");
                displayLoginScreen();
